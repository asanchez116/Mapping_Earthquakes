...
let torontoData = "https://raw.githubusercontent.com/asanchez116/Mapping_Earthquakes/Mapping_GeoJSON_Linestrings/torontoRoutes.json";
...
L.geoJson(data, {
  ...
  onEachFeature: function(feature, layer){
    console.log(layer);
    layer.bindPopup("<h2>" +"<u>"+ "Airline: " + feature.properties.airline +"</u>"+ "</h2>" +  "<h3>" + "Destination: " + feature.properties.dst + "</h3>");
  }
}, ).addTo(map);
});
